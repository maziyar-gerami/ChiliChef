...
import com.ict.chilichef.NavigationItems.Notes.TabNotesActivity;
...
public class TabDesignActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabLayout tabLayout = (TabLayout) findViewById(R.id.Design_tabLayout);
