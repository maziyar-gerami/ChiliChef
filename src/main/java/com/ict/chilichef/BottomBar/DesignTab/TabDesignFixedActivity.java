...
public class TabDesignFixedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_design_fixed);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TabDesignFixedActivity.this.finish();
            }
        });


        ViewPager viewPager = (ViewPager) findViewById(R.id.Design_viewPager_Fixed);
        setupViewPager(viewPager, cat);
        int x = setupViewPager(viewPager, cat);

        TabLayout tabLayout = (TabLayout) findViewById(R.id.Design_tabLayout_Fixed);
    ...
    private int setupViewPager(ViewPager viewPager, int cat) {
        ...
        for (i = counter - 1; i >= 0; i--) {
            ...
            designFragment.setArguments((arrayListBundle.get(i)));
            Adapter.addFragments(designFragment, titles.get(i));
        }
