 ...
 */
public class DesignFruitFragment extends Fragment implements Recycler_Design_Adapter.ClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_design_fruit, container, false);


        itemList = new ArrayList<>();


        recyclerview = (RecyclerView) v.findViewById(R.id.recycler_fruit_Design);
        prepareItem();
