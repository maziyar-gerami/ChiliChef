...
public class TabFoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_food);
        ...
        TabLayout tabLayout = (TabLayout) findViewById(R.id.Categories_tabLayout);
        tabLayout.setupWithViewPager(viewPager);

        tab = tabLayout.getTabAt(x - 1);
    ...
    private int setupViewPager(ViewPager viewPager, int cat) {
        ...
        for (i = counter - 1; i >= 0; i--) {
            ...
            categoriesFragment.setArguments(arrayListBundle.get(i));
            Adapter.addFragments(categoriesFragment, titles.get(i));
        }
