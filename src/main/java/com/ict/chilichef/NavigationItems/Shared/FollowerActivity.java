...
public class FollowerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (HttpManager.checkNetwork(FollowerActivity.this)) {

            FriendsFetch ff = new FriendsFetch(FollowerActivity.this);
    ...
    public class FriendsFetch extends AsyncTask<Integer, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.length() > 6) {
                ...
                Toast.makeText(FollowerActivity.this, R.string.emptyList, Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.GONE);
                checkNetLayout.setVisibility(View.GONE);
        ...
        protected String doInBackground(Integer... integers) {
            ...
            try {
                ...
                String jsonText = HttpManager.getFollowers(integers[0]);
