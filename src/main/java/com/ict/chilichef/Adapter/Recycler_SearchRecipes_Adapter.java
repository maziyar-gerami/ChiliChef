...
public class Recycler_SearchRecipes_Adapter extends RecyclerView.Adapter<Recycler_SearchRecipes_Adapter.ViewHolder> {
    ...
    public Recycler_SearchRecipes_Adapter(List<SearchRecipesModel> itemListSearchRecepies, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_search_recipes_layout, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(final View parent) {
            ...
            FoodImage = (ImageView) parent.findViewById(R.id.image_recFood);
            mainRelative = (RelativeLayout) parent.findViewById(R.id.Layout_SearchFood);
